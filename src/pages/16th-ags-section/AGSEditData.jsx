...
const AGSEditData = () => {
  ...
  useEffect(() => {
    if (singleDelegate) {
      const delegateData = { ...initialDelegateFormData };
      for (const key in delegateData) {
        if (
          singleDelegate.hasOwnProperty(key) &&
          singleDelegate[key] !== null
        ) {
      ...
      delegateData.companyName =
        singleDelegate.companyName || singleDelegate.company_name || "";
      delegateData.companyAddress =
        singleDelegate.companyAddress || singleDelegate.company_address || "";
      delegateData.companyCountry =
        singleDelegate.companyCountry || singleDelegate.company_country || "";
      delegateData.companyState =
        singleDelegate.companyState || singleDelegate.company_state || "";
      delegateData.companyCity =
        singleDelegate.companyCity || singleDelegate.company_city || "";
      delegateData.companyPin =
        singleDelegate.companyPin ||
        singleDelegate.company_pin ||
        singleDelegate.companyPincode ||
        "";
          ...
          >
            ...
            >
              ...
              <input
                ...
                value={formData.coordinator}
                onChange={handleChange}
                placeholder="Coordinator/Referral"
                className={inputClass}
                required
              />
            </div>
