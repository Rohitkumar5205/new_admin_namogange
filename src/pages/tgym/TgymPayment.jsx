        ...
        <div className="flex justify-between items-center bg-white rounded-md shadow-sm px-5 py-2 border border-gray-200">
          <div>
            <h2 className="text-lg font-medium text-gray-800">
              {data?.name || "TGYM"} Contestant Data
            </h2>
          </div>
        </div>
        {/*main container */}
            ...
            <table className="w-full text-sm text-left text-gray-600">
              ...
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-gray-50 ">
                  ...
                  <td className="px-4 py-3">TGMY/2021/538</td>
                  ...
                  <td className="px-4 py-3"> Audition Fee</td>
        ...
        <div className="bg-white shadow-sm rounded-lg border border-gray-200">
          <div className="flex justify-between items-center px-5 py-3 border-b border-gray-200">
            <div className="flex items-center gap-2">
              <FaMessage className="text-gray-500" />
              <h3 className="text-base font-medium text-gray-800">
                {data?.name || "TGYM"} Cancelled Payment
              </h3>
            </div>
            <button className="text-gray-600 hover:text-blue-600">
              <FaPrint size={18} />
