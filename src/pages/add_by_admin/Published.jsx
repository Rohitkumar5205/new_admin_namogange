...
import {
  ...
  updatePublished,
  deletePublished,
} from "../../redux/slices/add_by_admin/publishedSlice";
...
const Published = () => {
  ...
  const { list, loading } = useSelector((state) => state.published);
  ...
  const { canRead, canWrite, canDelete, isFormDisabled } = useRoleRights(PageNames.ADD_PUBLISHED);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        ...
        showSuccess("Submitted Data updated successfully ");
      } else {
        await dispatch(
          createPublished({
            name: formData.name,
        ...
        showSuccess("Submitted Data added successfully ");
      }
      dispatch(getAllPublished());
      resetForm();
      setCurrentPage(1);
  ...
  const handleDelete = (id) => {
    ...
    dispatch(deletePublished({ id, user_id: currentUserId })).then(() => {
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col text-center">
              ...
              <p className="text-sm text-blue-100">
                Add or update Submitted Published content including name and
                status.{" "}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Submitted Data Name <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                name="name"
          ...
          <table className="w-full text-sm text-left text-gray-600">
            <thead className="bg-gray-50 border-b  border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 font-medium">Data Name</th>
