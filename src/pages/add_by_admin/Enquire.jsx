    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-md shadow-sm px-5 py-2 border border-gray-200">
        <h2 className="text-lg font-medium text-gray-800">
          Add Enquire Management
        </h2>
        <p className="text-sm text-gray-600 mt-1 max-w-3xl">
          Add or update Enquire content including title, image, link and status.
        </p>
      </div>
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Enquire Title <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name="title"
          ...
          <div className="md:col-span-1 flex justify-end gap-3 mt-6">
            ...
            >
              {isEdit ? "Update Enquire" : "Add Enquire"}
            </button>
          </div>
        </form>
      </div>
      ...
      <div className="relative overflow-x-auto bg-white shadow-sm rounded-lg border border-gray-200">
        <div className="px-5 py-3 border-b border-gray-200">
          <h3 className="text-base font-medium text-gray-800">Enquire List</h3>
        </div>
        ...
        <table className="w-full text-sm text-left text-gray-600">
          <thead className="bg-gray-50 border-b  border-gray-200">
            <tr>
              ...
              <th className="px-4 py-3">Enquire Title</th>
