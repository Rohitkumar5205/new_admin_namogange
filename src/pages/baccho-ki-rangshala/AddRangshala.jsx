...
//   return (
//     <div>
//       <h2> Add Rangshala Page</h2>
//     </div>
//   )
// }

// export default AddRangshala
...
const AddRangshala = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      isEdit
        ? "Rangshala updated successfully ✅"
        : "Rangshala added successfully ✅"
    );
    setFormData({
      college_name: "",
      category: "",
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-white rounded-md shadow-sm px-5 py-2 border border-gray-200">
        <h2 className="text-lg font-medium text-gray-800">
          Add Rangshala Management
        </h2>

        <button
          onClick={() => navigate("/baccho-ki-rangshala/rangshala-list")}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 className="text-base font-medium text-gray-800 mb-4">
          {isEdit ? "Update Rangshala" : "Add New Rangshala"}
        </h3>
