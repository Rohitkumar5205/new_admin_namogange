...
const CollegeList = () => {
  ...
  const {
    ...
    canWrite,
    canDelete,
  } = useRoleRights(PageNames.ADD_COLLEGE);
          ...
          <div className="flex items-center gap-4">
            <div className="flex flex-col ">
              ...
              <p className="text-sm text-blue-100">
                Manage and oversee all college details and information in one
                place.
              </p>
            </div>
          </div>
                ...
                currentData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-1 rounded text-xs ${item?.status === "Active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                      >
                        {item?.status}
                      </span>
                    </td>
